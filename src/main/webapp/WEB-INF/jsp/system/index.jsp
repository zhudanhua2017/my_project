		        ...
		        <div class="iheader">
		            ...
		            <div style="height: 44px;">
		                ...
		                <div class="h_info">
							...
							欢迎您！&nbsp; 当前日期：<% Date date = new Date();SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); %><%=sdf.format(date) %>&nbsp;&nbsp;&nbsp;&nbsp;
		            ...
		            <ul class="nav" id="mainMenuUI">
		            	...
		            	<!-- <li onclick="clickFirstMenu(this)" class="on"> <a><span>统计报表</span></a></li> -->
		            </ul>
		        </div>
		    </div>
		    <div id="container">
		        <table style="vertical-align:top" cellspacing="0" cellpadding="0" bgcolor="#e1e9eb" border="0">
		            ...
		            <tr>
		                <td class="leftTd" style="vertical-align:top" width="150">
		                    <div class="left">
		                        <!-- <div class="ileft" id="menuDiv"><h3 onclick="clickSecondMenu(this)"><a>权限管理</a></h3> -->
		                        <div class="ileft" id="menuDiv"><h3 onclick="clickSecondMenu(this,'${basePath}/ad')"><a>广告管理</a></h3></div>
		                        <div class="ileft" id="menuDiv"><h3 onclick="clickSecondMenu(this,'${basePath}/businesses')"><a>商户管理</a></h3></div>
		                        <div class="ileft" id="menuDiv"><h3 onclick="clickSecondMenu(this,'${basePath}/orders')"><a>订单查询</a></h3></div>
		                        <div class="ileft" id="menuDiv"><h3 onclick="clickSecondMenu(this,'${basePath}/comments')"><a>评论查询</a></h3></div>
		                    </div>
		                </td>
		                <td width="7">
