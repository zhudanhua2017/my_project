...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form id="mainForm" method="post" action="${basePath}/businesses/search">
						...
						<tbody>
							<tr>
	                            ...
	                            <td style="text-align: right;" width="150">
	                            	...
	                            	<input class="tabSub" value="添加" onclick="location.href='${basePath}/businesses/addInit'" type="button"/>
	                            </td>
	       					</tr>
						</tbody>
					</table>
